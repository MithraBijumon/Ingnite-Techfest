...
const navbar = () => {
  ...
  return (
    <div className={`  top-0 w-screen  ${isOpen ? "h-auto" : "h-18"} z-10 flex flex-col sm:flex-row items-center justify-between `}>
      <div className='flex'>
      ...
      <div className="sm:flex items-center justify-center gap-7 me-10 text-[19px] hidden">
        <a
          href="#about"
          className="relative text-white after:content-[''] after:absolute after:left-1/2 after:-bottom-1 after:w-0 after:h-[2px] after:bg-white after:transition-all after:duration-300 after:ease-out hover:after:left-0 hover:after:w-full"
        >
          About
        </a>
        <a
      ...
      {isOpen && (
        <div className="sm:hidden flex flex-col items-center gap-4 mt-4 mb-7 overflow-clip">
          ...
          <a href="#incentive" className="text-white hover:underline transition duration-300">Incentives</a>
          <a href="#Collabration" className="text-white hover:underline transition duration-300">Collabrations</a>
          <a href="#contact" className="text-white hover:underline transition duration-300">Contact us</a>
        </div>
      )}
    </div>
